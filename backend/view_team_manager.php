            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">View Team Manager </h4>
                ...
                <div class="col-xl-12 col-xs-12">
                    <div class="card-box items">
                      <div style="padding: 10px;"></div>
                       <h3 style="color: #333;text-align:left;font-size: 20px">Team Managers </h3>
                         <table  style="color: #333;" class="table table-striped table-hover">
                          ...
                          <tbody>
                            <?php 
                            try {
                                  $stmt = $pdo->prepare('SELECT * FROM `student` WHERE `type_user`="Team Manager" ORDER BY date DESC');
