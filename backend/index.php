...
<html lang="en">
  ...
  <body style="background-color:#07163e;background-size:100% cover; background-image: url(wass.jpg);background-size: cover;">
        ...
        <div style="padding: 20px;text-align: center;position: relative;z-index: 10">
          ...
          <center>
            <form method="POST" action="login_redirect.php"  novalidate onsubmit="return validate();">
             <div style="padding: 40px;background-color: #fff;width: 340px;box-shadow: 0px 0px 10px rgba(0,0,0,.24);">
                 <div style="padding: 5px;"></div>
                 <img src="loj.jpg" style="width: 150px;">
              ...
              <!-- <div style="padding: 10px;"></div>-->
                ...
                <div class="row">
                  <div class="col-sm-12">
                   <button class="inputss " name="login" style="width: 100%;background-color: #c94014;border:0px">LogIn</button>
                  </div>
                </div>
                <br/>
