...
<div class="topbar">
    <div class="topbar-left" style="border-bottom: solid 1px #ddd">
        <a href="dashboard.php" class="logo" id="logo-tour"><img src="iop.png" style="width: 30px;"> <span style="border-top:solid 10px transparent;">IGKV, RPR</span></a>
    </div>


    <nav class="navbar navbar-custom" style="background-color: #598823">
